...
public class InformationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action == null) {
            ...
            if (action.equalsIgnoreCase("updatePassword")) {
                doPost_UpdatePassword(request, response);
            } else if (action.equalsIgnoreCase("updateInfor")) {
                doPost_UpdateInfor(request, response);
            }
        }
    ...
    private void doPost_UpdatePassword(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher rd = request.getRequestDispatcher("views/common/AccountInformation.jsp");
        rd.forward(request, response);
    }

    private void doPost_UpdateInfor(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        RequestDispatcher rd = request.getRequestDispatcher("views/common/AccountInformation.jsp");
        rd.forward(request, response);
    }
}
