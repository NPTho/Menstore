 ...
 * @author MyPC
 */
@WebServlet(name = "RunningOutStockController", urlPatterns = {"/running-out-stock"})
public class RunningOutStockController extends HttpServlet {
    ...
    protected void delete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //list = productDAO.list((page - 1) * recordsPerPage, recordsPerPage);
        response.sendRedirect(request.getContextPath() + "/running-out-stock");
    }
